...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('u/assets/img/gear.svg') }}" type="image/x-icon">
    <!-- General CSS Files -->
    <link rel="stylesheet" href="{{ asset('u/assets/modules/bootstrap/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('u/assets/modules/fontawesome/css/all.min.css') }}">

    <!-- CSS Libraries -->
    <link rel="stylesheet" href="{{ asset('u/assets/modules/select2/dist/css/select2.min.css') }}">
    <link rel="stylesheet" href="{{ asset('u/assets/css/select2-bootstrap4.css') }}" />

    <!-- Template CSS -->
    <link rel="stylesheet" href="{{ asset('u/assets/css/style.css') }}">
    <link rel="stylesheet" href="{{ asset('u/assets/css/components.css') }}">

    <script src="{{ asset('u/assets/modules/jquery.min.js') }}"></script>
    <script src="{{ asset('u/assets/js/sweetalert.min.js') }}"></script>
...
<body style="background: #e2e8f0">
    ...
    <!-- General JS Scripts -->
    <script src="{{ asset('u/assets/modules/popper.js') }}"></script>
    <script src="{{ asset('u/assets/modules/bootstrap/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('u/assets/modules/nicescroll/jquery.nicescroll.min.js') }}"></script>
    <script src="{{ asset('u/assets/js/stisla.js') }}"></script>
    <script src="{{ asset('u/assets/modules/select2/dist/js/select2.full.min.js') }}"></script>
